---
description: >
  Full multi-platform paid advertising audit with sequential analysis.
...
4. **Analyze each platform sequentially:**
   - **Google Ads** → read `.agent/skills/ads-google/SKILL.md` + `ads/references/google-audit.md` (G01-G74)
   - **Meta Ads** → read `.agent/skills/ads-meta/SKILL.md` + `ads/references/meta-audit.md` (M01-M46)
   - **Creative** → read `.agent/skills/ads-creative/SKILL.md` (LinkedIn, TikTok, Microsoft creative + cross-platform)
   - **Tracking** → read `ads/references/conversion-tracking.md` (LinkedIn, TikTok, Microsoft tracking + cross-platform)
   - **Budget** → read `.agent/skills/ads-budget/SKILL.md` (LinkedIn, TikTok, Microsoft budget/bidding + cross-platform allocation)
   - **Compliance** → read `ads/references/compliance.md` (All-platform compliance, settings, performance benchmarks)
