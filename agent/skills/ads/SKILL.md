...
LinkedIn, TikTok, Microsoft). Orchestrates 12 specialized sub-skills.

## Quick Reference

| Command | What it does |
|---------|-------------|
| `/ads audit` | Full multi-platform audit with sequential analysis |
...
3. Analyze each platform sequentially using the corresponding sub-skill:
   - **Google Ads** → read `.agent/skills/ads-google/SKILL.md` (74 checks)
   - **Meta Ads** → read `.agent/skills/ads-meta/SKILL.md` (46 checks)
   - **LinkedIn Ads** → read `.agent/skills/ads-linkedin/SKILL.md` (25 checks)
   - **TikTok Ads** → read `.agent/skills/ads-tiktok/SKILL.md` (25 checks)
   - **Microsoft Ads** → read `.agent/skills/ads-microsoft/SKILL.md` (20 checks)
   - **Creative** → read `.agent/skills/ads-creative/SKILL.md` (cross-platform)
...
**Path resolution:** All references are at `.agent/skills/ads/references/`.
...
1. **ads-audit** — Full multi-platform audit with sequential analysis
...
## Inline Audit Instructions

When running a full audit (`/ads audit`), process each platform sequentially:

### Google Ads Analysis (G01-G74)
Read `.agent/skills/ads-google/SKILL.md` and `.agent/skills/ads/references/google-audit.md`.
Focus on Critical checks first (5.0x severity multiplier):
...
### Meta Ads Analysis (M01-M46)
Read `.agent/skills/ads-meta/SKILL.md` and `.agent/skills/ads/references/meta-audit.md`.
Focus on Critical checks first (5.0x severity multiplier):
- M01: Meta Pixel installed and firing
- M02: CAPI active (30-40% data loss without it post-iOS 14.5)
- M03: Event deduplication (≥90% dedup rate)
- M04: EMQ ≥8.0 for Purchase
- M25: Creative format diversity (≥3 formats)
- M28: Creative fatigue (CTR drop >20% over 14 days)

### Cross-Platform Creative Analysis
Read `.agent/skills/ads-creative/SKILL.md`.
Evaluate creative quality for LinkedIn, TikTok, Microsoft.

### Cross-Platform Tracking Health
Verify conversion tracking consistency across all active platforms.
Read `.agent/skills/ads/references/conversion-tracking.md`.

### Budget & Bidding Analysis
Read `.agent/skills/ads-budget/SKILL.md` and `.agent/skills/ads/references/budget-allocation.md`.
Evaluate allocation, bidding strategy, and scaling readiness for LinkedIn, TikTok, Microsoft.

### Compliance Check
Read `.agent/skills/ads/references/compliance.md`.
Verify compliance, settings, performance across all platforms.
